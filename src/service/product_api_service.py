...
class ProductApiService:
    ...
    def get_all_products(self) -> List[Product]:
        ...
        return [ProductMapper.to_product(product) for product in products]
    ...
    def get_all_products_by_category(self, user_type: UserType, category: str) -> List[Product]:
        products = (
            self.product_api_client.send_get_all_products_request()
            .check(
                Conditions.status_code(HTTPStatus.OK),
    ...
    def get_all_product_titles_by_category(self, user_type: UserType, category: str) -> List[str]:
        products = (
            self.product_api_client.send_get_all_products_request()
            .check(
                Conditions.status_code(HTTPStatus.OK),
