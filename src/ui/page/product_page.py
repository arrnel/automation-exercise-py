...
class ProductPage(BasePage):
    ...
    def __init__(self):
        ...
        self.__product_details_component = ProductDetailsComponent(self._page_container.element(".product-details"), "Product Details")
    ...
    # ACTIONS
    @step_log.log("Open [Product Page]: /product_details/{_URL_PATTERN.format(product_id=product_id)}")
