        ...
        return [
            ...
            (
                ...
                DataGenerator.random_user().with_phone_number(
                    DataGenerator.random_word(range_util.phone_number_range.min_val)
                ),
            ),
            (
                "'mobile_number' length = min + 1",
                DataGenerator.random_user().with_phone_number(
                    DataGenerator.random_word(
            ...
            (
                ...
                DataGenerator.random_user().with_phone_number(
                    DataGenerator.random_word(range_util.phone_number_range.max_val)
                ),
            ),
            # Birth day
            (
